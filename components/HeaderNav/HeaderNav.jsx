    ...
    <div>
        <Box sx={styles.navContainer}>
            ...
            <Box sx={styles.navCon}>
                    <Link href='/'>
                      <Typography sx={[styles.navLink, router.pathname =='/' && styles.navLinkActive]}>Home</Typography>
                    </Link>
                    <Link href='announcements'>
                      <Typography sx={[styles.navLink, router.pathname=='/announcements' && styles.navLinkActive]}>Announcement</Typography>
                    </Link>
                    <Link href='students'>
                      <Typography sx={[styles.navLink, router.pathname=='/students' && styles.navLinkActive]}>Students</Typography>
                    </Link>
                    <Link href='about'>
                      <Typography sx={[styles.navLink, router.pathname=='/about' && styles.navLinkActive]}>About Us</Typography>
                    </Link>
                    <Link href='contact'>
                      <Typography sx={[styles.navLink, router.pathname=='/contact' && styles.navLinkActive]}>Contact Us</Typography>
                    </Link>
                </Box>
