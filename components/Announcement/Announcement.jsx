...
const Announcement = () => {
    ...
    const [caption, setCaption] = useState(`Let's take a look back at the spectacular event and how it showcased the talents and skills of PSUans!
  ...
  return (
    <div>
        ...
        <Box sx={styles.postCon}>
            ...
            InputProps={{
                startAdornment:<Icon icon='uil:search' width={20}  style={{color:'grey',marginRight:'1px'}}/>,
            }}
            />
            ...
            <Box sx={styles.postBox}>
                ...
                <Box sx={styles.profileCon}>
                    <img className='headerLogo' src={'../assets/images/osas.png'} alt='osas logo' style={styles.logo} />
                ...
                <Box>
                    ...
                    <Typography variant='body2' sx={styles.caption}>
                        {
                            limit ?
                            caption.substring(0,520)
                            :
                            caption
                        }
                        {
                            limit ?
                            <Button onClick={()=>setLimit(false)} sx={{textTransform:'capitalize'}}>see more..</Button>
                            :
                            <Button onClick={()=>setLimit(true)} sx={{textTransform:'capitalize'}}>see less..</Button>
                        }
                ...
                <Box sx={styles.postImageCon}>
                    <img src={'../assets/images/pic1.jpg'} alt='post image' style={styles.postImage} />
                </Box>
                ...
                <Box sx={styles.commentCon}>
                    ...
                    <Box sx={styles.profileCon}>
                        <img className='headerLogo' src={'../assets/images/van.png'} alt='user' style={styles.logo} />
                        <Box sx={styles.commentNameCap}>
                            <Typography sx={styles.name}>Ivan Hamid</Typography>
                            <Typography sx={styles.commentText}>Go Sheena Mae!!! You're so galing galing! keep it up! Love love!! &#x1F9E1; &#x1F9E1;</Typography>
                        </Box>
                    </Box>
                    <Box sx={styles.profileCon}>
                        <img className='headerLogo' src={'../assets/images/mars.jpg'} alt='user' style={styles.logo} />
                        <Box sx={styles.commentNameCap}>
                            <Typography sx={styles.name}>Marcelito Cosicol</Typography>
                            <Typography sx={styles.commentText}>Grabe galing!! Cute girls! &#x1F9E1; </Typography>
                        </Box>
                    </Box>
                    <Box sx={styles.profileCon}>
                        <img className='headerLogo' src={'../assets/images/nel.png'} alt='user' style={styles.logo} />
                        <Box sx={styles.commentNameCap}>
                            <Typography sx={styles.name}>Jhonnel Garcia</Typography>
                            <Typography sx={styles.commentText}>Pretty ni Sheena!! Aking lang sya @Ivan Hamid  &#128527; &#x1F9E1;</Typography>
                        </Box>
                    </Box>

                    <Box sx={styles.commentField}>
                        <Box sx={styles.profileComCon}>
                            <img className='headerLogo' src={'../assets/images/jerick.png'} alt='user' style={styles.logo} />
                            <Box sx={[styles.commentAcc,{width:'100%'}]}>
                                <input placeholder='Write a comment...' style={styles.commentInput}/>
                                <Button onClick={()=>setLimit(false)} sx={{textTransform:'capitalize', color:primaryColor}}>Send</Button>
                            </Box>
                        </Box>
                    </Box>
